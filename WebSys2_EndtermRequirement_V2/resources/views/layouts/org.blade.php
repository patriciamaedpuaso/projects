        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="orgNavbar">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('org.accomplishments.index') ? 'active' : '' }}" href="{{ route('org.accomplishments.index') }}">Accomplishments</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('org.events') ? 'active' : '' }}" href="{{ route('org.events') }}">Events</a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('org.profile.edit') ? 'active' : '' }}" href="{{ route('org.profile.edit') }}">Profile</a></li>
                </ul>
